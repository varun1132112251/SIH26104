...
if TYPE_CHECKING:
    from ml.inference.cnn import CNNInference
...
def get_inference_service() -> "CNNInference":
    ...
    try:
        ...
        raise RuntimeError("CNN inference dependencies are unavailable.") from exc
...
def create_app() -> FastAPI:
    ...
    @app.post(f"{settings.API_PREFIX}/inference", include_in_schema=False)
